...
CREATE TABLE DEBEZIUM.TESTNUMBERWITHNULLVALUE (
                                   ID NUMBER(9, 0) NOT NULL,
                                   NUMBERTYPE NUMBER,
                                   PRIMARY KEY(ID)
);

ALTER TABLE DEBEZIUM.TESTNUMBERWITHNULLVALUE ADD SUPPLEMENTAL LOG DATA (ALL) COLUMNS;
INSERT INTO DEBEZIUM.TESTNUMBERWITHNULLVALUE (ID,NUMBERTYPE) VALUES (1,null);
